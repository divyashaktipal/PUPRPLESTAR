    ...
    <div class="container">
        ...
        <div class="row blogs_container">
            <div class="col-lg-4 blog_item_col">
                <div class="blog_item">
                    <div class="blog_background" 
                         style="background-image:url('images/blog_1.jpg'); 
                                box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.3);"></div>
                    <div class="blog_content d-flex flex-column align-items-center justify-content-center text-center">
                        <h4 class="blog_title">Here are the trends I see coming this fall</h4>
                        <span class="blog_meta">by admin | Dec 01, 2024</span>
                        <a class="blog_more text-warning" href="#">Read more</a>
                    </div>
                </div>
            </div>
                ...
                <div class="blog_item">
                    <div class="blog_background" 
                         style="background-image:url('images/blog_2.jpg'); 
                                box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.3);"></div>
                    <div class="blog_content d-flex flex-column align-items-center justify-content-center text-center">
                        <h4 class="blog_title">How to choose the best stationery for your workspace</h4>
                        <span class="blog_meta">by admin | Dec 05, 2024</span>
                        <a class="blog_more text-warning" href="#">Read more</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 blog_item_col">
                <div class="blog_item">
                    <div class="blog_background" 
                         style="background-image:url('images/blog_3.jpg'); 
                                box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.3);"></div>
                    <div class="blog_content d-flex flex-column align-items-center justify-content-center text-center">
                        <h4 class="blog_title">Top 5 creative ways to use journals</h4>
                        <span class="blog_meta">by admin | Dec 10, 2024</span>
                        <a class="blog_more text-warning" href="#">Read more</a>
                    </div>
                </div>
            </div>
        ...
        <div class="row mt-5">
            <div class="col text-center">
                <a href="#" class="btn btn-warning text-dark fw-bold">Read More</a>
            </div>
        </div>
    </div>
