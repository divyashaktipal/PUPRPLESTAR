...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['edit_product'])) {
    ...
    $stmt = $conn->prepare("UPDATE products SET name = ?, price = ?, stock = ?, tags = ?, category = ? WHERE id = ?");
    $stmt->bind_param("sdissi", $productName, $productPrice, $productStock, $productTags, $productCategory, $productId);
    $stmt->execute();
    $stmt->close();
}
...
<body>
    ...
    <!-- Sidebar -->
    <a href = 'admin_dashboard.php'><div class="sidebar" id="sidebar">
        <a href="#">Dashboard</a>
    ...
    <div class="main">
        ...
        <form action="admin_dashboard.php" method="post" enctype="multipart/form-data">
            ...
            <button type="submit" name="add_product" style = "background-color: green;">Add Product</button><hr/>
        </form>
